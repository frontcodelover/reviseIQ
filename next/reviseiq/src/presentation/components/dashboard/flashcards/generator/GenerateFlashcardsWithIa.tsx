      ...
      <Card className='space-y-6 p-6'>
        <div className='space-y-2'>
          <div className='space-y-4'>
            ...
            <Input type='text' placeholder='Subject' value={topic} onChange={(e) => setTopic(e.target.value)} className='w-full' />
          </div>
        </div>

        <div className='space-y-4'>
          <Label htmlFor='number-slider'>{t('flashcard.nbFlashcard')}</Label>
          <Slider id='number-slider' value={[number]} onValueChange={(value) => setNumber(value[0])} min={1} max={50} step={1} className='w-full' />
        ...
        <div className='space-y-4'>
          ...
          <RadioGroup defaultValue={level} onValueChange={(value: 'easy' | 'medium' | 'hard') => setLevel(value)} className='grid grid-cols-3 gap-4'>
            <div>
